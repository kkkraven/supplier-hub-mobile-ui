...
export function MassFactoryImport({ onImport }: MassFactoryImportProps) {
  ...
  const handleExportTemplate = () => {
    const csvContent = "data:text/csv;charset=utf-8," + 
      "name,nameEn,city,province,category,subcategory,moq,leadTime,certifications,description,established,employees,capacity\n" +
      "Example Factory,Example Factory,广州 / Guangzhou,Guangdong,knit,Premium Knit,300,15,GOTS;OEKO-TEX,Premium quality knit factory,2010,100-150,30000";
