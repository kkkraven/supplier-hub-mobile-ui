          ...
          <AnimatedList animation="rotate-in" staggerDelay={0.1} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category, index) => (
              <Card 
                ...
                onClick={() => onNavigate?.('category-detail', category.slug)}
              >
          ...
          <AnimatedList animation="slide-up" staggerDelay={0.1} className="grid md:grid-cols-4 gap-8">
            ...
            <div className="animate-fade-up">
              ...
              <ul className="space-y-2 text-gray-400">
                <li><button onClick={() => onNavigate?.('catalog')} className="animate-nav-item hover:text-white transition-all duration-300">Каталог фабрик</button></li>
                <li><button onClick={() => onNavigate?.('pricing')} className="animate-nav-item hover:text-white transition-all duration-300">Тарифы</button></li>
