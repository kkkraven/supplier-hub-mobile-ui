...
- **Cloudflare Pages** - быстрый и бесплатный хостинг (рекомендуется) 
...
Подробная инструкция по развертыванию на Cloudflare Pages доступна в файле [CLOUDFLARE_PAGES_SETUP.md](./CLOUDFLARE_PAGES_SETUP.md).

**Быстрый старт:**
1. Подключите GitHub репозиторий к Cloudflare Pages
2. Настройте переменные окружения (Supabase ключи)
3. Деплой произойдет автоматически при push в master ветку
...
- [Деплой на Cloudflare Pages](./CLOUDFLARE_PAGES_SETUP.md)
- [Исправления деплоя](./CLOUDFLARE_DEPLOY_FIX.md)
